...
export default function TaskMode({ question, options, onChoose, correctId, onAnswer }: Props) {
  ...
  return (
    <div>
      <div className="text-xl font-semibold text-[#9B7EBD] mb-4">{question}</div>
      <div className="flex flex-col gap-3">
        {options.map((o, idx) => {
          const baseColor = o.color || palette[idx % palette.length];
